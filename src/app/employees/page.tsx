...
import { Employee, EmployeeRole, ROLE_OPTIONS } from "@/lib/types";
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-3">
                    ...
                    <span
                      className={`px-2.5 py-0.5 rounded-full text-[10px] font-extrabold uppercase tracking-wider flex items-center gap-1 ${
                        emp.role === "SUPER_ADMIN" || emp.role === "ADMIN"
                          ...
                          : emp.role === "MANAGER" || emp.role === "TEAM_LEAD"
                    ...
                    >
                      ...
                      <span>{ROLE_OPTIONS.find((r) => r.value === emp.role)?.label || emp.role}</span>
                    </span>
                  </div>
